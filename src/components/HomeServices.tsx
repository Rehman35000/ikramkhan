...
const services = [
  ...
  {
    title: 'AI Solutions',
    description: 'Intelligent systems powered by machine learning and advanced data analytics.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Cloud-native infrastructure designed for reliability, security, and scale.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-accent font-semibold tracking-wider uppercase text-sm mb-4">Our Services</p>
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            What We <span className="gradient-text">Build</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From concept to deployment, we deliver end-to-end technology solutions that drive growth.
          </p>
        </motion.div>
        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="glass-panel rounded-2xl p-8 border border-border group cursor-pointer relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                >
                  Learn more
                  <svg className="w-4 h-4 ml-1 group-hover:ml-2 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
