  ...
  return (
    <section ref={sectionRef} className="relative py-40 px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        backgroundImage: `radial-gradient(circle at 1px 1px, ${theme === 'light' ? 'rgba(0,0,0,0.04)' : 'rgba(255,255,255,0.04)'} 1px, transparent 0)`,
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <motion.div style={{ scale: textScale }}>
          ...
          >
            <p className="text-[11px] font-semibold tracking-[0.25em] uppercase mb-6" style={{ color: c.accent }}>
              Let&apos;s work together
            </p>
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-[-0.03em] mb-6 leading-[1.05]" style={{ color: c.fg }}>
              Ready to build{' '}
              <span className="gradient-text">something great?</span>
            </h2>
            <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-12 leading-[1.7]" style={{ color: c.fgSecondary }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <MagneticButton strength={0.15}>
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 hover:scale-105 group"
                  style={{
          ...
          >
            {[
              ...
              <div key={item} className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke={c.accent} strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
                <span className="text-xs font-medium" style={{ color: c.fgSecondary }}>{item}</span>
              </div>
            ))}
          </motion.div>
        </motion.div>
